...
class FRPDPBlock(nn.Module):
    """
    FR-PDP block used in TickNet.
    Structure:
    1x1 pointwise -> 3x3 depthwise -> 1x1 pointwise -> SE -> residual/projection
    """
...
class TickNetMultiTask(nn.Module):
    def __init__(
        self,
        init_conv_channels,
        init_conv_stride,
